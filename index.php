...
<head>
    ...
    <title>Brighter Brain Academy | Real Education Breeds Value</title>
...
<body class="sticky-header">
    ...
    <div id="main-wrapper" class="main-wrapper">
        ...
        <div class="hero-banner hero-style-1">
                        ...
                        <div class="banner-content">
                            ...
                            <ul class="shape-group">
                                <li class="shape-1 scene" data-sal-delay="1000" data-sal="fade" data-sal-duration="1000">
                                    <img data-depth="2" src="_vendors/images/about/shape-13.png" alt="Shape">
                                </li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="banner-thumbnail">
                            <div class="thumbnail" data-sal-delay="500" data-sal="slide-left" data-sal-duration="1000">
                                <img src="_vendors/images/banner/girl-1.webp" alt="Girl Image">
                            </div>
                            <div class="instructor-info" data-sal-delay="600" data-sal="slide-up" data-sal-duration="1000">
                                <div class="inner">
                                    ...
                                    <div class="media">
                                        <div class="thumb">
                                            <img src="_vendors/images/banner/author-1.png" alt="Images">
                                        </div>
                                        <div class="content">
                            ...
                            <ul class="shape-group">
                                <li class="shape-1" data-sal-delay="1000" data-sal="fade" data-sal-duration="1000">
                                    <img data-depth="1.5" src="_vendors/images/about/shape-15.png" alt="Shape">
                                </li>
                                <li class="shape-2 scene" data-sal-delay="1000" data-sal="fade" data-sal-duration="1000">
                                    <img data-depth="-1.5" src="_vendors/images/about/shape-16.png" alt="Shape">
                                </li>
                                ...
                                <li class="shape-4" data-sal-delay="1000" data-sal="fade" data-sal-duration="1000">
                                    <img data-depth="-1" src="_vendors/images/counterup/shape-02.png" alt="Shape">
                                </li>
                                <li class="shape-5 scene" data-sal-delay="1000" data-sal="fade" data-sal-duration="1000">
                                    <img data-depth="1.5" src="_vendors/images/about/shape-13.png" alt="Shape">
                                </li>
                                <li class="shape-6 scene" data-sal-delay="1000" data-sal="fade" data-sal-duration="1000">
                                    <img data-depth="-2" src="_vendors/images/about/shape-18.png" alt="Shape">
                                </li>
                            </ul>
                        </div>
                    </div>
            ...
            <div class="shape-7">
                <img src="_vendors/images/about/h-1-shape-01.png" alt="Shape">
            </div>
        </div>
        <!--=====================================-->
        <!--=       Features Area Start      =-->
            ...
            <div class="container">
                <div class="features-grid-wrap">
                    <div class="features-box features-style-2 edublink-svg-animate">
                        <div class="icon">
                            <img class="svgInject" src="_vendors/images/animated-svg-icons/online-class.svg" alt="animated icon">
                        </div>
                        <div class="content">
                    ...
                    <div class="features-box features-style-2 edublink-svg-animate">
                        <div class="icon">
                            <img class="svgInject" src="_vendors/images/animated-svg-icons/instructor.svg" alt="animated icon">
                        </div>
                        <div class="content">
                    ...
                    <div class="features-box features-style-2 edublink-svg-animate">
                        <div class="icon certificate">
                            <img class="svgInject" src="_vendors/images/animated-svg-icons/certificate.svg" alt="animated icon">
                        </div>
                        <div class="content">
                    ...
                    <div class="features-box features-style-2 edublink-svg-animate">
                        <div class="icon">
                            <img class="svgInject" src="_vendors/images/animated-svg-icons/user.svg" alt="animated icon">
                        </div>
                        <div class="content">
                ...
                <div class="row g-5 align-items-center">
                    <div class="col-lg-6">
                        <div class="about-image-gallery">
                            <img class="main-img-1" src="_vendors/images/about/about-01.webp" alt="About Image">
                            <div class="video-box" data-sal-delay="150" data-sal="slide-down" data-sal-duration="800">
                                <div class="inner">
                                    <div class="thumb">
                                        <img src="_vendors/images/about/about-02.webp" alt="About Image">
                            ...
                            <ul class="shape-group">
                                <li class="shape-1 scene" data-sal-delay="500" data-sal="fade" data-sal-duration="200">
                                    <img data-depth="1" src="_vendors/images/about/shape-36.png" alt="Shape">
                                </li>
                                <li class="shape-2 scene" data-sal-delay="500" data-sal="fade" data-sal-duration="200">
                                    <img data-depth="-1" src="_vendors/images/about/shape-37.png" alt="Shape">
                                </li>
                                <li class="shape-3 scene" data-sal-delay="500" data-sal="fade" data-sal-duration="200">
                                    <img data-depth="1" src="_vendors/images/about/shape-02.png" alt="Shape">
                                </li>
                            </ul>
                        </div>
                    </div>
                            ...
                            <div class="inner">
                                <div class="thumbnail">
                                    <a href="course-details.html">
                                        <img src="_vendors/images/course/course-07.jpg" alt="Course Meta">
                                    </a>
                                    <div class="time-top">
                    ...
                    <div class="col-md-6 col-xl-3" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
                        <div class="edu-course course-style-1 hover-button-bg-white">
                            <div class="inner">
                                <div class="thumbnail">
                                    <a href="course-details.html">
                                        <img src="_vendors/images/course/course-04.jpg" alt="Course Meta">
                                    </a>
                                    <div class="time-top">
                    ...
                    <div class="col-md-6 col-xl-3" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
                        <div class="edu-course course-style-1 hover-button-bg-white">
                            <div class="inner">
                                <div class="thumbnail">
                                    <a href="course-details.html">
                                        <img src="_vendors/images/course/course-05.jpg" alt="Course Meta">
                                    </a>
                                    <div class="time-top">
                    ...
                    <div class="col-md-6 col-xl-3" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
                        <div class="edu-course course-style-1 hover-button-bg-white">
                            <div class="inner">
                                <div class="thumbnail">
                                    <a href="course-details.html">
                                        <img src="_vendors/images/course/course-06.jpg" alt="Course Meta">
                                    </a>
                                    <div class="time-top">
                    ...
                    <div class="col-lg-8">
                        <div class="counterup-box-wrap">
                            ...
                            <ul class="shape-group">
                                ...
                                <li class="shape-2">
                                    <img class="rotateit" src="_vendors/images/counterup/shape-02.png" alt="Shape">
                                </li>
                                <li class="shape-3 scene">
                                    <img data-depth="1.6" src="_vendors/images/counterup/shape-04.png" alt="Shape">
                                </li>
                                <li class="shape-4 scene">
                                    <img data-depth="-1.6" src="_vendors/images/counterup/shape-05.png" alt="Shape">
                                </li>
                            </ul>
                        </div>
                    </div>
                        ...
                        <div class="home-one-cta edu-cta-box bg-image">
                            ...
                            <ul class="shape-group">
                                <li class="shape-01 scene">
                                    <img data-depth="2" src="_vendors/images/cta/shape-06.png" alt="shape">
                                </li>
                                <li class="shape-02 scene">
                                    <img data-depth="-2" src="_vendors/images/cta/shape-12.png" alt="shape">
                                </li>
                                <li class="shape-03 scene">
                                    <img data-depth="-3" src="_vendors/images/cta/shape-04.png" alt="shape">
                                </li>
                            </ul>
                        </div>
                    </div>
                                ...
                                <div class="thumbnail-wrap">
                                    <div class="thumbnail">
                                        <a href="team-details.html">
                                            <img src="_vendors/images/team/team-01.webp" alt="team images">
                                        </a>
                                    </div>
                        ...
                        <div class="edu-team-grid team-style-1">
                            <div class="inner">
                                <div class="thumbnail-wrap">
                                    <div class="thumbnail">
                                        <a href="team-details.html">
                                            <img src="_vendors/images/team/team-02.webp" alt="team images">
                                        </a>
                                    </div>
                                    <ul class="team-share-info">
                                        <li><a href="#"><i class="icon-share-alt"></i></a></li>
                        ...
                        <div class="edu-team-grid team-style-1">
                            <div class="inner">
                                <div class="thumbnail-wrap">
                                    <div class="thumbnail">
                                        <a href="team-details.html">
                                            <img src="_vendors/images/team/team-03.webp" alt="team images">
                                        </a>
                                    </div>
                                    <ul class="team-share-info">
                                        <li><a href="#"><i class="icon-share-alt"></i></a></li>
                        ...
                        <div class="edu-team-grid team-style-1">
                            <div class="inner">
                                <div class="thumbnail-wrap">
                                    <div class="thumbnail">
                                        <a href="team-details.html">
                                            <img src="_vendors/images/team/team-04.webp" alt="team images">
                                        </a>
                                    </div>
                                    <ul class="team-share-info">
                                        <li><a href="#"><i class="icon-share-alt"></i></a></li>
        ...
        <div class="edu-cta-banner-area home-one-cta-wrapper bg-image">
            <div class="container">
                <div class="edu-cta-banner">
                    ...
                    <ul class="shape-group">
                        <li class="shape-01 scene">
                            <img data-depth="2.5" src="_vendors/images/cta/shape-10.png" alt="shape">
                        </li>
                        <li class="shape-02 scene">
                            <img data-depth="-2.5" src="_vendors/images/cta/shape-09.png" alt="shape">
                        </li>
                        <li class="shape-03 scene">
                            <img data-depth="-2" src="_vendors/images/cta/shape-08.png" alt="shape">
                        </li>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-7">
                        <div class="brand-grid-wrap">
                            ...
                            <div class="brand-grid">
                                <img src="_vendors/images/brand/brand-07.png" alt="Brand Logo">
                            </div>
                            <div class="brand-grid">
                                <img src="_vendors/images/brand/brand-08.png" alt="Brand Logo">
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="edu-blog-area blog-area-1 edu-section-gap">
            ...
            <ul class="shape-group">
                <li class="shape-1 scene">
                    <img data-depth="-1.4" src="_vendors/images/about/shape-02.png" alt="Shape">
                </li>
                <li class="shape-2 scene">
                    <span data-depth="2.5"></span>
                </li>
                <li class="shape-3 scene">
                    <img data-depth="-2.3" src="_vendors/images/counterup/shape-05.png" alt="Shape">
                </li>
            </ul>
        </div>
        <!-- End Blog Area  -->
