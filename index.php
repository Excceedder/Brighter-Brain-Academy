                    ...
                    <div class="header-navbar">
                            ...
                            <nav class="mainmenu-nav">
                                <ul class="mainmenu">
                                    ...
                                    <li class="has-droupdown"><a href="#">Tutorials</a>
                                        <ul class="submenu">
                                            <li><a href="course-one.html">JAMB</a></li>
                                            <li><a href="course-two.html">SSCE</a></li>
                                            <li><a href="course-three.html">POST UTME</a></li>
                                        </ul>
                                    </li>
                        ...
                        <div class="header-right">
                            <ul class="header-action">
                                <li class="header-btn">
                                    <a href="./termly_report/" target="_blank" class="edu-btn btn-medium btn-curved">Check Results <i class="icon-4"></i></a>
                                </li>
                    ...
                    <div class="col-lg-6">
                        <div class="about-image-gallery">
                            <div class="main-img-1">
                                <img src="_vendors/images/about/about-09.png" alt="About Image">
                            </div>
                            <div class="main-img-2 bounce-slide">
                                <img src="_vendors/images/about/about-10.png" alt="About Image">
                            </div>
                            <ul class="shape-group">
                                <li class="shape-1">
                                    <img src="_vendors/images/about/shape-11.png" alt="Shape">
                                </li>
                                <li class="shape-2">
                                    <img src="_vendors/images/about/shape-12.png" alt="Shape">
                                </li>
                                <li class="shape-3 scene">
                                    <img data-depth="1" src="_vendors/images/about/shape-13.png" alt="Shape">
                                </li>
                            </ul>
                        </div>
                    </div>
                            ...
                            <div class="inner">
                                <div class="thumbnail">
                                    <a href="course-details.html">
                                        <img src="_vendors/images/course/course-21.jpg" alt="Course Meta">
                                    </a>
                    ...
                    <div class="col-12 col-lg-4 col-md-6" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
                        <div class="edu-course course-style-7 bg-color-secondary">
                            <div class="inner">
                                <div class="thumbnail">
                                    <a href="course-details.html">
                                        <img src="_vendors/images/course/course-22.jpg" alt="Course Meta">
                                    </a>
                    ...
                    <div class="col-12 col-lg-4 col-md-6" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
                        <div class="edu-course course-style-7 bg-color-primary">
                            <div class="inner">
                                <div class="thumbnail">
                                    <a href="course-details.html">
                                        <img src="_vendors/images/course/course-23.jpg" alt="Course Meta">
                                    </a>
                ...
                <div class="row g-5 row--45 align-items-end">
                    ...
                    <div class="col-lg-6">
                        <div class="faq-thumbnail">
                            <div class="thumbnail">
                                <img src="_vendors/images/faq/faq-08.webp" alt="Faq Images">
                            </div>
                            <ul class="shape-group">
                                <li class="shape-1 scene">
                                    <img data-depth="1" src="_vendors/images/about/shape-12.png" alt="Shape Images">
                                </li>
                                <li class="shape-2 scene">
                                    <img data-depth="-1" src="_vendors/images/about/shape-13.png" alt="Shape Images">
                                </li>
                                <li class="shape-3 scene">
                                    <img data-depth="1" src="_vendors/images/faq/shape-15.png" alt="Shape Images">
                                </li>
                            </ul>
                        </div>
                    </div>
                            ...
                            <div class="inner">
                                <div class="thumbnail">
                                    <a href="event-details.html">
                                        <img src="_vendors/images/event/event-04.jpg" alt="Event Images">
                                    </a>
                                </div>
                                <div class="content">
                                    <ul class="event-meta">
                    ...
                    <div class="col-lg-6 col-12" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
                        <div class="edu-event-list event-list-3 bg-style-secondary">
                            <div class="inner">
                                <div class="thumbnail">
                                    <a href="event-details.html">
                                        <img src="_vendors/images/event/event-05.jpg" alt="Event Images">
                                    </a>
                                </div>
                                <div class="content">
                                    <ul class="event-meta">
                    ...
                    <div class="col-lg-6 col-12" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
                        <div class="edu-event-list event-list-3 bg-style-extra05">
                            <div class="inner">
                                <div class="thumbnail">
                                    <a href="event-details.html">
                                        <img src="_vendors/images/event/event-06.jpg" alt="Event Images">
                                    </a>
                                </div>
                                <div class="content">
                                    <ul class="event-meta">
                    ...
                    <div class="col-lg-6 col-12" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
                        <div class="edu-event-list event-list-3 bg-style-primary">
                            <div class="inner">
                                <div class="thumbnail">
                                    <a href="event-details.html">
                                        <img src="_vendors/images/event/event-07.jpg" alt="Event Images">
                                    </a>
                                </div>
                                <div class="content">
                                    <ul class="event-meta">
                            ...
                            <div class="inner">
                                <div class="thumbnail">
                                    <a href="blog-details.html">
                                        <img src="_vendors/images/blog/blog-07.jpg" alt="Blog Images">
                                    </a>
                                    <div class="read-more-btn">
                    ...
                    <div class="col-lg-4 col-md-6 col-12" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
                        <div class="edu-blog blog-style-3">
                            <div class="inner">
                                <div class="thumbnail">
                                    <a href="blog-details.html">
                                        <img src="_vendors/images/blog/blog-08.jpg" alt="Blog Images">
                                    </a>
                                    <div class="read-more-btn">
                                        <a class="btn-icon-round" href="blog-details.html"><i class="icon-4"></i></a>
                                    </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-12" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
                        <div class="edu-blog blog-style-3">
                            <div class="inner">
                                <div class="thumbnail">
                                    <a href="blog-details.html">
                                        <img src="_vendors/images/blog/blog-09.jpg" alt="Blog Images">
                                    </a>
                                    <div class="read-more-btn">
                                        <a class="btn-icon-round" href="blog-details.html"><i class="icon-4"></i></a>
                                    </div>
            ...
            <div class="container edublink-animated-shape">
                ...
                <ul class="shape-group">
                    <li class="shape-1 scene" data-sal-delay="150" data-sal="slide-right" data-sal-duration="800">
                        <img data-depth="-1" src="_vendors/images/banner/kid-1.webp" alt="shape">
                    </li>
                    <li class="shape-2 scene" data-sal-delay="150" data-sal="slide-left" data-sal-duration="800">
                        <img data-depth="1" src="_vendors/images/banner/kid-2.webp" alt="shape">
                    </li>
                    <li class="shape-3">
                        <img src="_vendors/images/banner/icon-1.png" alt="shape">
                    </li>
                    <li class="shape-4">
                        <img src="_vendors/images/banner/icon-2.png" alt="shape">
                    </li>
                </ul>
            </div>
        </div>
