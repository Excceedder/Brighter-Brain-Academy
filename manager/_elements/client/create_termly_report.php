...
?>
    ...
    <tr>
        ...
        <td><input type="number" name="nature_studies_first_ca_score" placeholder="0" class="form-control"></td>
        <td><input type="number" name="nature_studies_second_ca_score" placeholder="0" class="form-control"></td>
        <td><input type="number" name="nature_studies_examination_score" placeholder="0" class="form-control"></td>
    </tr>
    <tr>
        <td>Christian Religious Studies</td>
        <td><input type="number" name="christian_religious_studies_first_ca_score" placeholder="0" class="form-control"></td>
        <td><input type="number" name="christian_religious_studies_second_ca_score" placeholder="0" class="form-control"></td>
        <td><input type="number" name="christian_religious_studies_examination_score" placeholder="0" class="form-control"></td>
    </tr>
    <tr>
        <td>Health Habits</td>
...
?>
    ...
    <tr>
        ...
        <td><input type="number" name="physical_health_education_first_ca_score" placeholder="0" class="form-control"></td>
        <td><input type="number" name="physical_health_education_second_ca_score" placeholder="0" class="form-control"></td>
        <td><input type="number" name="physical_health_education_examination_score" placeholder="0" class="form-control"></td>
    </tr>
    <tr>
        <td>Basic Technology</td>
        <td><input type="number" name="basic_technology_first_ca_score" placeholder="0" class="form-control"></td>
        <td><input type="number" name="basic_technology_second_ca_score" placeholder="0" class="form-control"></td>
        <td><input type="number" name="basic_technology_examination_score" placeholder="0" class="form-control"></td>
    </tr>
    <tr>
        <td>Basic Science</td>
        <td><input type="number" name="basic_science_first_ca_score" placeholder="0" class="form-control"></td>
        <td><input type="number" name="basic_science_second_ca_score" placeholder="0" class="form-control"></td>
        <td><input type="number" name="basic_science_examination_score" placeholder="0" class="form-control"></td>
    </tr>
    <tr>
        <td>Social Studies</td>
        <td><input type="number" name="social_studies_first_ca_score" placeholder="0" class="form-control"></td>
        <td><input type="number" name="social_studies_second_ca_score" placeholder="0" class="form-control"></td>
        <td><input type="number" name="social_studies_examination_score" placeholder="0" class="form-control"></td>
    </tr>
    <tr>
        <td>Home Economics</td>
        <td><input type="number" name="home_economics_first_ca_score" placeholder="0" class="form-control"></td>
        <td><input type="number" name="home_economics_second_ca_score" placeholder="0" class="form-control"></td>
        <td><input type="number" name="home_economics_examination_score" placeholder="0" class="form-control"></td>
    </tr>
    <tr>
        <td>Creative Arts</td>
        <td><input type="number" name="creative_arts_first_ca_score" placeholder="0" class="form-control"></td>
        <td><input type="number" name="creative_arts_second_ca_score" placeholder="0" class="form-control"></td>
        <td><input type="number" name="creative_arts_examination_score" placeholder="0" class="form-control"></td>
    </tr>
    <tr>
        <td>Agricultural Science</td>
        <td><input type="number" name="agricultural_science_first_ca_score" placeholder="0" class="form-control"></td>
        <td><input type="number" name="agricultural_science_second_ca_score" placeholder="0" class="form-control"></td>
        <td><input type="number" name="agricultural_science_examination_score" placeholder="0" class="form-control"></td>
    </tr>
<?php
...
?>
    ...
    <tr>
        ...
        <td><input type="number" name="basic_science_and_technology_first_ca_score" placeholder="0" class="form-control"></td>
        <td><input type="number" name="basic_science_and_technology_second_ca_score" placeholder="0" class="form-control"></td>
        <td><input type="number" name="basic_science_and_technology_examination_score" placeholder="0" class="form-control"></td>
    </tr>
    <tr>
        <td>Creative Arts</td>
        <td><input type="number" name="creative_arts_first_ca_score" placeholder="0" class="form-control"></td>
    ...
    <tr>
        ...
        <td><input type="number" name="national_values_first_ca_score" placeholder="0" class="form-control"></td>
        <td><input type="number" name="national_values_second_ca_score" placeholder="0" class="form-control"></td>
        <td><input type="number" name="national_values_examination_score" placeholder="0" class="form-control"></td>
    </tr>
    <tr>
    ...
    <tr>
        <td>History</td>
        <td><input type="number" name="history_first_ca_score" placeholder="0" class="form-control"></td>
        <td><input type="number" name="history_second_ca_score" placeholder="0" class="form-control"></td>
...
?>
    ...
    <tr>
        ...
        <td><input type="number" name="business_studies_first_ca_score" placeholder="0" class="form-control"></td>
        <td><input type="number" name="business_studies_second_ca_score" placeholder="0" class="form-control"></td>
        <td><input type="number" name="business_studies_examination_score" placeholder="0" class="form-control"></td>
    </tr>
    <tr>
        <td>Literature</td>
        <td><input type="number" name="literature_first_ca_score" placeholder="0" class="form-control"></td>
